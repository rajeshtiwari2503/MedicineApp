...
import { Heading, Box ,VStack,Input,Button, View} from 'native-base'
...
export const RegistrationScreen = () => {
    return (
        ...
        <Box w="full" h="full" position="absolute" top="0" px="6" justifyContent="center"  >
            ...
            <VStack space={5} pt="6">
                  <Input InputLeftElement={<MaterialIcons name="person" size={20} color="black"  />} variant="outline" w="100%" pl={2}   placeholder='name' />
                  ...
                  <View ><Button  mt={5} w="40%" rounded="50" bg="black" >SIGN UP</Button>
                  <Button my={10} w="40%" rounded="50">SIGN IN</Button>
                  </View>
